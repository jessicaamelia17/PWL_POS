...
{
    $categories = KategoriModel::select('kategori_kode', 'kategori_nama')
    ...
    foreach ($categories as $category) {
        ...
        $sheet->setCellValue('B' . $baris, $category->kategori_kode);
        $sheet->setCellValue('C' . $baris, $category->kategori_nama);
        $baris++;
        $no++;
    }
